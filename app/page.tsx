  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            <div className="animate-fade-in max-w-5xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/pair-pro" className="glow-button px-10 py-4 rounded-xl font-semibold text-base tracking-wide uppercase transition-all duration-300 hover:shadow-2xl hover:shadow-white/10">
                  Pair X-Kira Pro
                </Link>
                <Link href="/pair" className="secondary-button font-semibold px-10 py-4 rounded-xl tracking-wide uppercase text-base transition-all duration-300">
                  Pair X-Kira
                </Link>
              </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Lightning Fast</h3>
                <p className="text-muted-foreground leading-relaxed">Optimized for speed with minimal resource usage</p>
              </div>
              ...
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Multi-Device</h3>
                <p className="text-muted-foreground leading-relaxed">Full WhatsApp Web multi-device support</p>
              </div>
              ...
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Plugin System</h3>
                <p className="text-muted-foreground leading-relaxed">Extensible architecture with custom plugins</p>
              </div>
              ...
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Group Management</h3>
                <p className="text-muted-foreground leading-relaxed">Advanced admin tools and moderation</p>
              </div>
              ...
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Media Downloads</h3>
                <p className="text-muted-foreground leading-relaxed">Built-in media processing and downloads</p>
              </div>
              ...
              <div className="card-hover rounded-xl p-8 group relative overflow-hidden">
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:text-indigo-400 transition-colors">Configurable</h3>
                <p className="text-muted-foreground leading-relaxed">Flexible commands and extensive configuration</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="getting-started" className="py-32 bg-gradient-to-b from-background via-muted/10 to-background relative overflow-hidden">
